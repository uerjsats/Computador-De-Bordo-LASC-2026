...
bool receiveImage()
{
    ...
    {
        DBG_WIFI(DBG_ERROR, "imagem maior que fb_buf (%zu > %d), descartando", currentImgSize, MAX_IMG_SIZE);
...
// ======================================
// ACESSO AO BUFFER DA ÚLTIMA IMAGEM
// (usado por taskTelemetria.cpp para envio via LoRa)
// ======================================
